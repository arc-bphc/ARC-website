        ...
        <div class="back">
          ...
          <div class="content">
            <div class="main">
              ...
              <a href="/ARC-website/blog/viewPost.php?postid='.$projId[0].'"><p class="text-center">'.$projs[0].'</p></a>
              <a href="/ARC-website/blog/viewPost.php?postid='.$projId[1].'"><p class="text-center">'.$projs[1].'</p></a>
              <a href="/ARC-website/blog/viewPost.php?postid='.$projId[2].'"><p class="text-center">'.$projs[2].'</p></a>
